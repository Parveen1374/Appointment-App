...
const Card = () => (
  <ProfileCard>
    ...
    <DetailsContainer>
      <Detail>
        <IconPlaceholder src="/assets/Frame.png" alt="vector" />
        <p>Male/Female Infertility</p>
      </Detail>
      <Detail>
        <IconPlaceholder src="/assets/Vector.png" alt="frame" />
        <p>7 years of experience</p>
      </Detail>
      <Detail>
        <IconPlaceholder src="/assets/comment.png" alt="comment" />
    ...
    <ButtonContainer>
      <ButtonWhite>View Profile</ButtonWhite>
      <ButtonGreen>Book a consultation</ButtonGreen>
    </ButtonContainer>
  </ProfileCard>
);
